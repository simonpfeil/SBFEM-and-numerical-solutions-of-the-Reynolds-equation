...
tilt_h_shell = 0;                                                          % tilting angle of the shell around the horizontal axis of the inertial system [rad]
tilt_v_shell = 0;                                                          % tilting angle of the shell around the vertical axis of the inertial system [rad]
tilt_dot_h_shell = 0;                                                      % rate of change of the tilting angle of the shell around the horizontal axis of the inertial system [rad/s]
tilt_dot_v_shell = 0;                                                      % rate of change of the tilting angle of the shell around the vertical axis of the inertial system [rad/s]
tilt_h_shaft = 0;                                                          % tilting angle of the shaft around the horizontal axis of the inertial system [rad]
tilt_v_shaft = 0;                                                          % tilting angle of the shaft around the vertical axis of the inertial system [rad]
tilt_dot_h_shaft = 0;                                                      % rate of change of the tilting angle of the shaft around the horizontal axis of the inertial system [rad/s]
tilt_dot_v_shaft = 0;                                                      % rate of change of the tilting angle of the shaft around the vertical axis of the inertial system [rad/s]
